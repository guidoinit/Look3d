...
public:
    ...
    SCENE::ModeDocument getmodedocument();
    SCENE::ModeEdit geteditmode();
    void addObject(pl3d_mesh_struct);
    void addmesh(l3d_mesh_type,l3d_float *par);
    void makevbo(int io);
    void addBone();
    //void addObjectSphere(sphereuv);
    void draw();
    void draw_elements();
    void draw_elements_edit();
    void drawvbo();
    void drawtexture();
    void drawedit();
    void draweditvertex();
    ...
    void addmaterialandset(pl3d_material_struct);
...
private:
    ...
    pl3d_mesh_struct _meshnull;

};

#endif // MAINSCENEDOCUMENT_H
