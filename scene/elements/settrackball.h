#ifndef SETTRACKBALL_H
#define SETTRACKBALL_H
#include <math.h>
...
public:
    ...
    void set(float sx,float sy,float wx, float wy);
    void run(float,float,float,float);
    l3d_vertex_fast mapping(int,int,int,int);
...
private:
    float _sx,_sy,_wx,_wy;
    l3d_vertex_fast lastpoint;
